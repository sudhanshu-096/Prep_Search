import { Image,ScrollView, ImageBackground,FlatList,TouchableWithoutFeedback, StyleSheet, Dimensions,Platform, Text, TextInput, TouchableOpacity, View, KeyboardAvoidingView, Pressable } from 'react-native'
...
const StudentCreateProfile = () => {
  ...
  <KeyboardAwareScrollView showsVerticalScrollIndicator={false}keyboardShouldPersistTaps={'always'}>
       ...
       <BackButton onPress={()=>navigation.goBack()} bgColor="#FDBA31" color="#000"/>
            ...
            <Text style={{marginTop:isSmallScreen?55:60, alignSelf:'center', fontSize:isSmallScreen?22:25,fontWeight:'600', color:"#fff"}}>Create Your Profile</Text>
...
<RadioButton.Group style={{position:"absolute"}} onValueChange={(value) => {setSelectedGender(value),setShowGender(false)}} value={selectedGender}>
 ...
 <View style={{backgroundColor:"#fff", height:50, width:isSmallScreen?330:350, borderRadius:10, flexDirection:'row',marginLeft:30,marginTop:30}}>
      ...
      <TextInput placeholder={`Parent's Email*`}
      placeholderTextColor={'black'}
      style={{fontSize:isSmallScreen?15:16, fontWeight:'400', left:10}}
       value={parentEmail}
   ...
   <View style={{backgroundColor:"#fff", height:50, width:isSmallScreen?330:350, borderRadius:10, flexDirection:'row',marginLeft:30,marginTop:20}}>
      ...
      <TextInput placeholder={`Parent's Phone Number*`} 
      placeholderTextColor={'black'}
      style={{fontSize:isSmallScreen?15:16, fontWeight:'400', left:10}}
       value={parentsPhone}
   ...
   <View style={{backgroundColor:"#fff", height:50, width:isSmallScreen?330:350, borderRadius:10, flexDirection:'row',marginLeft:30,marginTop:20}}>
      ...
      <TextInput placeholder={`Student's Email`} 
      placeholderTextColor={'black'}
      style={{fontSize:isSmallScreen?15:16, fontWeight:'400', left:10}}
       value={studentEmail}
   ...
   <View style={{backgroundColor:"#fff", height:50, width:isSmallScreen?330:350, borderRadius:10, flexDirection:'row',marginLeft:30,marginTop:20}}>
      ...
      <TextInput placeholder={`Student's Phone Number`} 
      placeholderTextColor={'black'}
      style={{fontSize:isSmallScreen?15:16, fontWeight:'400', left:10}}
       value={studentPhone}
...
<View style={{backgroundColor:"#fff", marginTop:20, height:50, width:isSmallScreen?330:350, borderRadius:10, flexDirection:'row'}}>
      ...
      <View  style={styles.textInputContainer}>
        ...
        />
      <TouchableWithoutFeedback onPress={() => setShowMajor(!showMajor)}>
        <View style={{ marginLeft: 10,
       justifyContent: 'center', }}>
  ...
  <View style={{backgroundColor:"#fff",height:360, width:isSmallScreen?330:350, borderRadius:10}}>
                          ...
                          <TextInput
                            ...
                            placeholder="Search Academic Major"
                        ...
                        <FeatherIcon name="search" size={isSmallScreen ? 18 : 20} color="#aaa" style={{ marginEnd: 3 }} />
                          ...
                          <TouchableOpacity onPress={()=>setShowMajor(false)} style={{width:isSmallScreen?100:130, height:40,marginLeft:5, marginTop:30,borderRadius:10, backgroundColor:'#FDBA31', alignSelf:"left", justifyContent:'center', alignItems:"center"}}>
...
<View style={{backgroundColor:"#fff", height:50, marginTop:20, width:isSmallScreen?330:350, borderRadius:10, flexDirection:'row'}}>
   ...
   <View style={{backgroundColor:"#fff", height:50, marginTop:20, width:isSmallScreen?330:350, borderRadius:10, flexDirection:'row'}}>
      ...
      <TextInput placeholder='SAT Score' 
      placeholderTextColor={'black'}
      style={{fontSize:isSmallScreen?15:16, fontWeight:'400', left:10}}
      value={SATScore}
   ...
   <View style={{backgroundColor:"#fff", height:50, marginTop:20, width:isSmallScreen?330:350, borderRadius:10, flexDirection:'row'}}>
      ...
      <TextInput placeholder='ACT Score' 
      placeholderTextColor={'black'}
      style={{fontSize:isSmallScreen?15:16, fontWeight:'400', left:10}}
      value={ActScore}
   ...
   <View style={{backgroundColor:"#fff", height:50, marginTop:20, width:isSmallScreen?330:350, borderRadius:10, flexDirection:'row'}}>
      ...
      <TextInput placeholder='High School Address*' 
      placeholderTextColor={'black'}
      style={{fontSize:isSmallScreen?15:16, fontWeight:'400', left:10}}
...
<View style={{backgroundColor:"#fff", marginTop:20, height:50, width:isSmallScreen?330:350, borderRadius:10, flexDirection:'row'}}>
      ...
      <View  style={styles.textInputContainer}>
        ...
        />
      <TouchableWithoutFeedback onPress={() => setShowPosition(!showPosition)}>
        <View style={{ marginLeft: 10,
       justifyContent: 'center', }}>
       <FeatherIcon name={showSport ? "chevron-up" : "chevron-down"} size={20} color="gray" /> 
      </View>
  ...
  <View style={{backgroundColor:"#fff",height:360, width:isSmallScreen?330:350, borderRadius:10}}>
                        ...
                        <FeatherIcon name="search" size={isSmallScreen ? 18 : 20} color="#aaa" style={{ marginEnd: 3 }} />
                          ...
                          <TouchableOpacity onPress={()=>setShowPosition(false)} style={{width:isSmallScreen?100:130, height:40,marginLeft:5, marginTop:30,borderRadius:10, backgroundColor:'#FDBA31', alignSelf:"left", justifyContent:'center', alignItems:"center"}}>
                          <Text style={{fontSize:isSmallScreen?14:16,fontWeight:"600", color:"#032D62"}}>Apply</Text>
                         </TouchableOpacity>
...
<View style={{backgroundColor:"#fff", height:50, width:isSmallScreen?330:350, borderRadius:10, flexDirection:'row',marginTop:20}}>
      ...
      <TextInput placeholder={`NCAA Eligibility Center ID`} 
      placeholderTextColor={'black'}
      style={{fontSize:isSmallScreen?15:16, fontWeight:'400', left:10}}
       value={NCA}
   ...
   <View style={{backgroundColor:"#fff", height:50, width:isSmallScreen?330:350, borderRadius:10, flexDirection:'row',marginTop:20}}>
      ...
      <TextInput placeholder={`NAIA Eligibility Center ID`} 
      placeholderTextColor={'black'}
      style={{fontSize:isSmallScreen?15:16, fontWeight:'400', left:10}}
       value={NCIA}
